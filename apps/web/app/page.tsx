...
export default function Home() {
 ...
 <div className="mx-auto max-w-4xl text-center"><p className="eyebrow">Ditt lokala gym</p><h1 className="selector-heading metal-text">Träna på dina villkor.<br/><span className="metal-secondary">Nära dig.</span></h1><p className="mt-6 text-base leading-7 text-white/75 sm:text-lg">Personliga gym i Timrå och Sundsvall. Välj din anläggning och prova ett pass gratis.</p><a href="#valj-anlaggning" className="button button-light mt-8">Bli medlem</a></div>
